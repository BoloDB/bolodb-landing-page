...
const CONFIG = {
  ...
  background: {
    color: "transparent", // Use transparent instead of hard black to preserve landing page background
  },
};
...
const Particles = () => {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uParticleColorBase: {
        value: new THREE.Color(CONFIG.particles.colorBase),
      },
      uParticleColorOne: {
        value: new THREE.Color(CONFIG.particles.colorOne),
      },
      uParticleColorTwo: {
        value: new THREE.Color(CONFIG.particles.colorTwo),
      },
      uParticleColorThree: {
        value: new THREE.Color(CONFIG.particles.colorThree),
      },
    }),
    []
  );
  ...
  useFrame((state) => {
    ...
    if (hovering.current) {
      ...
      targetX =
        (baseX + jitterX * jitterRadius * CONFIG.cursor.strength) *
        followStrength;
      targetY =
        (baseY + jitterY * jitterRadius * CONFIG.cursor.strength) *
        followStrength;
    }
